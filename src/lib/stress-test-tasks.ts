...
export async function runTaskStressTest() {
  ...
  for (let i = 0; i < 1000; i++) {
    ...
    domains.push({
      ...
      levelOfNeed: 3,
      howToAchieve: `STRESS TEST METHOD ${i}: Staff must follow the premium protocol for ${baseTitle}. This involves complex steps and detailed recording in the care record. Full clinical length is mandatory. ${'Y'.repeat(500)}`,
