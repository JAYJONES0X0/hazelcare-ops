...
## 4. Liability
While we strive for 100% accuracy in our intelligence layers, operational decisions remain the responsibility of the registered manager. {{ORG_NAME}} is not liable for clinical outcomes or regulatory findings resulting from system interactions.
