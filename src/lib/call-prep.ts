...
export function buildCallPrepScript(
  ...
  if (variant === 'urgent') {
    lines = [
      ...
      ``,
      `"You've put in ${esc.entryCount} entries this period. The quality score is sitting at ${esc.qualityScore} out of 100, and ${shortPct}% of your notes are not meeting our required standard."`,
      ``,
    ...
    lines = [
      ...
      ``,
      `"You've got ${esc.entryCount} entries in ${locationRef} — the activity is there. The quality score is ${esc.qualityScore} out of 100 right now, mainly down to ${topGap}."`,
      ``,
      `(Brief pause)`,
      ``,
    ...
    lines = [
      ...
      ``,
      `"You've got ${esc.entryCount} entries in ${locationRef} — the activity is there. But the quality score is coming in at ${esc.qualityScore} out of 100, and ${shortPct}% of your notes are below the length we need. The main gap I'm seeing is ${topGap}."`,
      ``,
      `(Brief pause)`,
      ``,
