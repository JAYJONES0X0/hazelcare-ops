...
export function buildCallPrepScript(
  ...
  if (variant === 'message') {
    ...
    lines = [
      `Hi ${firstName},`,
      ``,
      `I've been reviewing your recent notes ${locationRef}. While the care you're providing is great, I've noticed your documentation is a bit brief at the moment.`,
      ``,
      `Specifically, we're looking for more detail around: ${topGap}.`,
      ``,
      `Currently, some entries are showing as ${notePattern}. It's really important that our records tell the full story of the support being given.`,
      ``,
      `Here is an example of the standard ${ORG_CONFIG.name} expects:`,
      `${goldExample}`,
      ``,
      `Can you please ensure your next entries follow this pattern? It helps protect both you and the service.`,
      ``,
      `Thanks,`,
      `Operations Team`,
    ];
    ...
    lines = [
      ...
      `Subject: Documentation Standards — Supporting Your Records`,
      ``,
      `Dear ${firstName},`,
      ``,
      `I am writing following a review of the care diary entries ${locationRef} for the current period.`,
      ``,
      `First, I want to acknowledge the quality of care you are delivering on shift. However, I have noted that your written documentation is currently not providing the depth of clinical detail required by ${ORG_CONFIG.name} and expected under inspection frameworks.`,
      ``,
      `OBSERVATION`,
      `──────────────────────────────`,
      `Your current entries are frequently presenting as ${notePattern}. It's essential that our written records adequately evidence every decision you make and every action you take to support our clients safely.`,
      ``,
      `REQUIRED STANDARD`,
      `──────────────────────────────`,
      `All entries should be written in the first person, reflect the individual's presentation at the time, and clearly show your professional decision-making.`,
      ``,
      ...
      `NEXT STEPS`,
      `──────────────────────────────`,
      `Please ensure that your documentation from your next shift onwards meets this standard. This feedback is provided to support your professional practice and will be noted as a coaching contact on your supervision record.`,
      ``,
      `If you have any questions or find that you're hitting barriers (like time pressure or app issues) that make this difficult, please let your manager know so we can support you.`,
      ``,
      `Kind regards,`,
      ``,
