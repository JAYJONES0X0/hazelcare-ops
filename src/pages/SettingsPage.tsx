...
export function SettingsPage({ onSignOut }: Props) {
  ...
  const inputClass = 'w-full bg-hc-dark/60 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-hc-text placeholder:text-hc-text/20 focus:outline-none focus:border-hc-teal/50 transition-colors';
