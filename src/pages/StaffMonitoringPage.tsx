    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          ...
          <div key={label} className="rounded-xl px-4 py-3" style={{background:'linear-gradient(145deg,rgba(16,18,26,0.9),rgba(10,12,18,0.85))',backdropFilter:'blur(20px)',border:'1px solid rgba(255,255,255,0.07)',boxShadow:'0 4px 20px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.04)'}}>
      ...
      {/* Filters */}
      <div className="rounded-2xl overflow-hidden mb-6" style={{background:'linear-gradient(145deg,rgba(16,18,26,0.9),rgba(10,12,18,0.85))',backdropFilter:'blur(20px)',border:'1px solid rgba(255,255,255,0.07)',boxShadow:'0 4px 20px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.04)'}}>
      ...
      {!weekData && !importLoading && (
        <div
          ...
          style={{
            background: importDragging ? 'rgba(20,184,166,0.06)' : 'linear-gradient(145deg,rgba(16,18,26,0.9),rgba(10,12,18,0.85))',
      ...
      {weekData && (
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_1fr_1.4fr] gap-6">
          {/* Houses */}
          <div className="rounded-2xl overflow-hidden" style={{background:'linear-gradient(145deg,rgba(16,18,26,0.92),rgba(10,12,18,0.88))',backdropFilter:'blur(28px) saturate(1.4)',border:'1px solid rgba(255,255,255,0.07)',boxShadow:'0 8px 40px rgba(0,0,0,0.5),inset 0 1px 0 rgba(255,255,255,0.05)'}}>
      ...
      {/* Recent outcomes */}
      <div className="mt-8 rounded-2xl overflow-hidden" style={{background:'linear-gradient(145deg,rgba(16,18,26,0.9),rgba(10,12,18,0.85))',backdropFilter:'blur(20px)',border:'1px solid rgba(255,255,255,0.07)',boxShadow:'0 4px 20px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.04)'}}>
