...
export function BriefingPage({ weekData, actions, incidents, setPage }: Props) {
  ...
  return (
    <div className="p-4 lg:p-6 w-full max-w-[2560px] mx-auto animate-in fade-in duration-700">

      {/* ── Header ── */}
      <div className="rounded-2xl p-4 mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
        style={{
          background: 'linear-gradient(145deg,rgba(16,18,26,0.95),rgba(10,12,18,0.9))',
        ...
        <div className="space-y-4">
          ...
          {(redFlags.length > 0 || overdueActions.length > 0) && (
            <div className="rounded-2xl overflow-hidden"
              style={{background:'linear-gradient(145deg,rgba(16,18,26,0.92),rgba(10,12,18,0.88))',border:'1px solid rgba(239,68,68,0.2)',boxShadow:'0 4px 20px rgba(239,68,68,0.05)'}}>
          ...
          {priorityClients.length > 0 && (
            <div className="rounded-2xl overflow-hidden"
              style={{background:'linear-gradient(145deg,rgba(16,18,26,0.92),rgba(10,12,18,0.88))',border:'1px solid rgba(255,255,255,0.07)'}}>
