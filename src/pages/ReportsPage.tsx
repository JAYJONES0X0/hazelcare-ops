    ...
    <div className="p-6 lg:p-10 max-w-[2560px] mx-auto animate-in fade-in duration-700">
      ...
      <div className="flex flex-col xl:flex-row gap-10">
        ...
        <div className="flex-1 min-h-[600px] hc-clay-raised overflow-hidden relative">
           ...
           <div className="p-10">
              <div className="flex items-center justify-between mb-10 pb-6 border-b border-hc-border/20">
                 <div className="flex items-center gap-4">
                    <Clock className="w-4 h-4 text-hc-muted" />
                    <span className="text-[11px] font-black text-hc-muted uppercase tracking-[0.2em]">Live Simulation: 06/04/2026 – 16/04/2026</span>
                 </div>
                 <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl hc-clay-raised text-[11px] font-black text-hc-teal uppercase hover:scale-105 transition-all">
              ...
              <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                 <div className="grid grid-cols-2 gap-10">
                    <div className="hc-clay-inset p-8">
                       <div className="text-[11px] font-black text-hc-muted uppercase tracking-[0.3em] mb-4">Operational Summary</div>
                    ...
                    <div className="hc-clay-inset p-8">
                       <div className="text-[11px] font-black text-hc-muted uppercase tracking-[0.3em] mb-4">Clinical Density</div>
                 ...
                 <div className="hc-clay-raised p-8">
                    <div className="flex items-center justify-between mb-6">
                       <div className="text-[11px] font-black text-hc-text uppercase tracking-[0.2em]">Regional Station Performance</div>
                       <span className="pill text-[11px]">Verified</span>
                    </div>
                         ...
                         <div key={h.house} className="flex items-center justify-between py-4 border-b border-hc-muted/5 last:border-0">
                            ...
                            <div className="flex items-center gap-6">
                               <div className="flex flex-col items-end">
                                  <span className="text-[11px] font-black text-hc-teal">{h.quality}%</span>
                                  <div className="h-0.5 w-16 hc-clay-inset rounded-full overflow-hidden"><div className="h-full bg-hc-teal" style={{width: `${h.quality}%`}} /></div>
                               </div>
                               <span className={`text-[11px] font-black ${h.flags > 0 ? 'text-flag-red' : 'text-hc-muted'}`}>{h.flags} Flags</span>
                            </div>
                         </div>
                       ))}
                    </div>
