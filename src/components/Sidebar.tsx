...
const navSections: { heading?: string; items: { id: Page; label: string; icon: ReactNode }[] }[] = [
  ...
  },
  {
    heading: 'Output',
    items: [
      { id: 'client-docs' as Page, label: 'Client Documents', icon: <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg> },
