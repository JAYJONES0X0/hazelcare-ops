...
import { LogOut, Sun, Moon, Info, Settings } from 'lucide-react';
...
const navSections: { items: { id: Page; label: string; icon: ReactNode }[] }[] = [
  ...
  },
  {
    items: [
      ...
      { id: 'templates', label: 'BUILDER TEMPLATES', icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg> },
      ...
      { id: 'settings' as Page, label: 'SYSTEM SETTINGS', icon: <Settings className="w-4 h-4" /> },
